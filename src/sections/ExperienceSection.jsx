    ...
    <section className="section-padding" aria-labelledby="experience-heading">
      <div className="container-shell">
        <SectionHeading
          ...
          title="Saya mulai dari dasar, lalu banyak belajar sambil mencoba."
          description="Sekolah memberi saya fondasi. Proyek dan PKL membuat saya terbiasa melihat langsung apa yang terjadi saat service error, trafik bermasalah, atau konfigurasi belum tepat."
        ...
        <div className="grid gap-5 lg:grid-cols-[0.92fr_1.08fr]">
          ...
          >
            <motion.article variants={sectionReveal} className="polish-card rounded-[1.25rem] border border-cyan-300/15 bg-cyan-300/[0.025] p-6 sm:p-7">
              ...
              <p className="mt-7 technical-label">Yang sedang saya jalani</p>
          ...
          >
            <div className="flex items-center justify-between gap-4 border-b border-white/[0.07] pb-5">
              <div>
                <p className="technical-label">Perjalanan belajar</p>
                <h3 className="mt-2 text-xl font-semibold tracking-[-0.02em] text-slate-100">Dari dasar IT sampai mulai mendalami security.</h3>
              </div>
              ...
              {compactTimeline.map((item, index) => (
                <motion.li key={item.year} variants={sectionReveal} className="grid grid-cols-[76px_1fr] gap-5 sm:grid-cols-[96px_1fr]">
                  <time className="font-mono text-xs font-semibold text-cyan-200">
                    {item.year === '2026' ? 'Sekarang' : item.year}
                  </time>
            ...
            {currentEducation ? (
              <motion.article variants={sectionReveal} className="mt-8 border-t border-white/[0.07] pt-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="technical-label">Sekolah · {currentEducation.startYear}—Sekarang</p>
